class Cataloging::User < ActiveRecord::Base
  ...
  has_many :entries, :class_name => Cataloging::Entry, :dependent => :restrict
  ...
  has_many :subordinates, :class_name => Cataloging::User, :foreign_key => "supervisor_id", :dependent => :restrict
