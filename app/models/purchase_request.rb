class PurchaseRequest < ActiveRecord::Base
  ...
  SUBJECTS_EMAILS = {
    ...
    "Global Affairs" => "jkayongo@nd.edu",
    "History - American " => "rbohlman@nd.edu",
    "History - European" => "jschneid@nd.edu",
    "History - Latin American" => "ehosselk@nd.edu",
    "History - North American" => "rbohlman@nd.edu",
    "History - Science and Technology" => "jross@nd.edu",
    "History - World" => "ehosselk@nd.edu",
    ...
    "South Asian Studies" => "ehosselk@nd.edu",
