class PurchaseRequest < ActiveRecord::Base
  ...
  SUBJECTS_EMAILS = {
    ...
    "Engineering" => "jladwig@nd.edu",
    "English and American Literature" => "aclemen1@nd.edu",
    "English Language" => "aclemen1@nd.edu",
    ...
    "Library and Information Studies" => "bpietras@nd.edu",
