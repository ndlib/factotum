class PurchaseRequest < ActiveRecord::Base
  ...
  SUBJECTS_EMAILS = {
    ...
    "Books, Bibliography" => "mullins.12@nd.edu",
    "Business" => "bpietras@nd.edu",
    "Byzantine Studies" => "dgura1@nd.edu",
    ...
    "Classical Languages and Literature" => "dgura1@nd.edu",
    ...
    "General Studies" => "mullins.12@nd.edu",
    ...
    "Program of Liberal Studies" => "Julie.K.Tanaka@nd.edu",
    "Psychology" => "lmorgan1@nd.edu",
