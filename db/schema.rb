...
ActiveRecord::Schema.define(:version => 20140609165905) do
  ...
  add_index "directory_employee_units", ["employee_id"], :name => "index_directory_employee_units_on_employee_id"
  add_index "directory_employee_units", ["organizational_unit_id"], :name => "index_directory_employee_units_on_organizational_unit_id"
