...
selector_funds = [
  ...
  ["Sullivan, David","ALBL"],
  ["Sullivan, David","ALBRA"],
  ["Sullivan, David","ALFO"],
  ["Sullivan, David","ALHERN"],
  ["Sullivan, David","ALMULL"],
  ["Sullivan, David","ALSC"],
  ["Sullivan, David","ALTHO"],
  ["Sullivan, David","ALTOR"],
  ["Sullivan, David","ANAST"],
  ["Sullivan, David","BYZA"],
  ["Sullivan, David","CLAC"],
  ["Sullivan, David","CLACSO"],
  ["Sullivan, David","FRHI"],
  ["Sullivan, David","KCLASSIC"],
  ["Sullivan, David","MBYZ"],
  ["Sullivan, David","MBYZSO"],
  ["Sullivan, David","VACCA"],
]
