...
describe Maps::MapCallNumberRangesController do
  ...
  describe "user" do
    ...
    describe "#destroy" do
      ...
      it "destroys the map_file" do
        ...
        delete :destroy, map_file_id: call_number_range.map_file.id, building_id: building.id, id: call_number_range.id
  ...
  describe "anonymous" do
    it "should prompt to log in" do
      ...
      get :new, map_file_id: call_number_range.map_file.id, building_id: building.id
      response.should be_redirect
    end
  end
