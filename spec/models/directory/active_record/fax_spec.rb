...
describe DirectoryFax do
  ...
  describe "validations" do
    ...
    it "saves with valid params" do
      DirectoryFax.new(valid_params).save.should be_true
    end 


    it "is invalid with just letters" do
      DirectoryFax.new(letter_params).should_not be_valid
    end 


    it "is invalid with wrong number of numbers" do
      DirectoryFax.new(number_params).should_not be_valid
    end 
