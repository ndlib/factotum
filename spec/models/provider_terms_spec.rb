...
describe ProviderTerms do
    ...
    describe '#get_terms' do
        ...
        it 'sets the correct key values' do
            expect(@terms.keys[0]).to eq(:interlibrary_loan_terms)
            expect(@terms.keys[1]).to eq(:coursepack_terms)
        end

        it 'sets the correct interlibrary loan terms' do
        ...
        it 'sets the correct coursepack terms' do
        ...
        it 'sets the correct ILL effective date' do
        ...
        it 'sets the correct coursepack effective date' do
        ...
        it 'sets the correct last update dates' do
            expect(@terms[:interlibrary_loan_terms]['Elsevier ScienceDirect Open Access Journals, Elsevier SD Backfile, Elsevier SD Freedom Collection'][:ill_last_update_date]).to eq('02/10/2017')
            expect(@terms[:coursepack_terms]['Elsevier ScienceDirect Open Access Journals, Elsevier SD Backfile, Elsevier SD Freedom Collection'][:coursepack_last_update_date]).to eq('03/15/2018')
        end
    end
